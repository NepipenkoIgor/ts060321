...
speakLikeSloth1(['hi', 'ts', 'is', 'awesome']);
speakLikeSloth2(['hi', 'ts', 'is', 'awesome']);
speakLikeSloth3(['hi', 'ts', 'is', 'awesome']);
speakLikeSloth4(['hi', 'ts', 'is', 'awesome']);
speakLikeSloth5(['hi', 'ts', 'is', 'awesome']);
